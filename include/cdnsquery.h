...
namespace CachedDNS
{
   ...
   public:
      ...
      SEvent *getCompletionEvent() { return m_event; }
      SEvent *setCompletionEvent(SEvent *event) { return m_event = event; }
      ...
      std::string &getErrorMsg() { return m_errmsg; }
      std::string &setErrorMsg(const char *errmsg) { return m_errmsg = errmsg; }
      std::string &setErrorMsg(const std::string &errmsg) { return m_errmsg = errmsg; }
